...
func _ready() -> void:
	...
	telegraph_tween_values = [Vector2.ZERO, Vector2(direction * 3,0)]
...
func _on_TriggerArea2D_body_entered(body):
	if body.is_in_group(Constants.GROUP_PLAYER):
		...
		telegraph_tween.interpolate_property(animated_sprite, "offset", telegraph_tween_values[0], telegraph_tween_values[1], telegraph_time, Tween.TRANS_QUAD, Tween.EASE_IN_OUT)
