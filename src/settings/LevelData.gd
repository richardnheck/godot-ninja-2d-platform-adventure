...
var levelsArray = [
	...
	{"world": WORLD3, "name" : "Obake Kaidan", "scene_path" : WORLD3_LEVELS_PATH + "Level2.tscn", "bgm" : CAVE_LEVEL_BGM},
	{"world": WORLD3, "name" : "Master my Mushin", "scene_path" : WORLD3_LEVELS_PATH + "Level3.tscn", "bgm" : CAVE_LEVEL_BGM},
