...
onready var sfx_env_falling_spike : AudioStreamPlayer2D = $SFX/Environments/Sfx_FallingSpike
onready var sfx_env_candle_explosion : AudioStreamPlayer2D = $SFX/Environments/Sfx_CandleExplosion
onready var sfx_env_canon_ball_explosion : AudioStreamPlayer2D = $SFX/Environments/Sfx_CanonBallExplosion
onready var sfx_env_canon_shoot : AudioStreamPlayer2D = $SFX/Environments/Sfx_CanonShoot
...
onready var sfx_env_shirime_snore: AudioStreamPlayer2D = $SFX/Environments/Sfx_ShirimeSnore
onready var sfx_env_shirime_walk: AudioStreamPlayer2D = $SFX/Environments/Sfx_ShirimeWalk
onready var sfx_env_fish_splash: AudioStreamPlayer2D = $SFX/Environments/Sfx_FishSplash
onready var sfx_env_hannya_scream: AudioStreamPlayer2D = $SFX/Environments/Sfx_HannyaScream
onready var sfx_env_hannya_alert: AudioStreamPlayer2D = $SFX/Environments/Sfx_HannyaAlert
onready var sfx_env_mini_wanyudo_explosion: AudioStreamPlayer2D = $SFX/Environments/Sfx_MiniWanyudoExplosion
