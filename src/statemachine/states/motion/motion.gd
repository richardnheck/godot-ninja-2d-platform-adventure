...
func update_look_direction(host: Character2, direction: Vector2) -> void:
...
func move(host: Character2, input_direction: Vector2, speed: float, acceleration: float) -> void:
