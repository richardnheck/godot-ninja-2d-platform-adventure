...
onready var start_button = $Buttons/List/Start
onready var checkpoint_list = $Checkpoints/VBoxContainer/ScrollContainer/List
onready var checkpoint_label = $Checkpoints/VBoxContainer/Checkpoints
